      ...
      <div className='home'>
        ...
        <div className="homeContainer">
          ...
          {completedTodos.length== 0?(
            <>
            <h1>No history</h1>
            <p>Add and complete task for history</p>
            </>
            ...
            <div key={item.id} className="homeitem">
              <div className="first-part">
                <div className="circle">M</div>
                <div className="taskDone">{item.todo}</div>
              </div>
              <div className="sec-part">

                <button className="delete" onClick={() => handelDel(item.id)}>
